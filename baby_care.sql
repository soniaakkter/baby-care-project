...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2021 at 11:46 AM
...
CREATE TABLE `messages` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `recipent` bigint(20) UNSIGNED DEFAULT NULL,
...
ALTER TABLE `messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `messages_recipent_foreign` (`recipent`),
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_recipent_foreign` FOREIGN KEY (`recipent`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `messages_sender_foreign` FOREIGN KEY (`sender`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
