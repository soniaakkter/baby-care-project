...
a.nav-link.custom-nav-link:hover {
    color: #401818f2!important;
}
    </style>
</head>
<body style="background-image:url({{asset('images/slider/01.jpg')}}); height: auto;background-attachment: fixed;background-size: cover;background-repeat: no-repeat;">
    <div id="app">
