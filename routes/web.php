...
Route::group(['middleware' => 'auth'],function(){
    ...
    Route::post('dashboard/message','DashboardController@message');
    ...
    // Booking
            Route::group(['middleware' => 'isAdmin'],function(){
                ...
                Route::get('admin/message_show','AdminMessageController@message_show');
                Route::post('admin/message_reply','AdminMessageController@message_reply');
            });
});
